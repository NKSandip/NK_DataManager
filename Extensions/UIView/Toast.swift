...
extension UIView {
    ...
    public func makeToast(_ message: String?, duration: TimeInterval, position: ToastPosition, title: String?, image: UIImage?, style: ToastStyle?, completion: ((_ didTap: Bool) -> Void)?) {
        ...
        do {
            ...
            //LogManager.logError("Error: message, title, and image are all nil")
        } catch {}
    }
    ...
    public func makeToast(_ message: String?, duration: TimeInterval, position: CGPoint, title: String?, image: UIImage?, style: ToastStyle?, completion: ((_ didTap: Bool) -> Void)?) {
        ...
        do {
            ...
            //LogManager.logError("Error: message, title, and image cannot all be nil")
        } catch {}
    }
    ...
    fileprivate func showToast(_ toast: UIView, duration: TimeInterval, position: CGPoint) {
        ...
        UIView.animate(withDuration: ToastManager.shared.style.fadeDuration, delay: 0.0, options: [.curveEaseIn, .allowUserInteraction], animations: { () -> Void in
            toast.alpha = 1.0
...
public struct ToastStyle {
     ...
     */
    public var backgroundColor = Color.lightWhiteColor.value// UIColor.init(colorLiteralRed: 0, green: 0, blue: 0, alpha: 0.8)
